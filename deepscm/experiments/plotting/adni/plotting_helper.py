ROOT_PATH = '../../../../'
adni_DATA_PATH = ROOT_PATH + 'assets/data/adni/'
BASE_LOG_PATH = ROOT_PATH + 'assets/models/adni/SVIExperiment'
...
downsample = 3
adni_test = ADNIDataset(data_dir, base_path=base_path, crop_type='center', downsample=downsample)

from deepscm.experiments.medical import adni  # noqa: F401
...
def plot_gen_intervention_range(model_name, interventions, idx, normalise_all=True, num_samples=32, save=False):
    ...
    orig_data = prep_data(adni_test[idx])
